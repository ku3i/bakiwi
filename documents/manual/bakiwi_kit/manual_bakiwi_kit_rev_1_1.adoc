...
Drehe die Platine nun vorsichtig um während du das soeben eingesetzte Bauteil mit den Fingern festhältst. Beginne nun damit, die Drahtenden auf der Platine festzulöten. Achte dabei darauf, den Draht und die Lötfläche um das Loch gleichmäßig aufzuheizen während du das Lötzinn hinzufügst.
