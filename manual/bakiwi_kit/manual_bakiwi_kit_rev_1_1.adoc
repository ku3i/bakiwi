...
ifdef::env-github[]
link:https://youtu.be/rAteGra5-xM[Direkter Link aufs Video, window="_blank"]
image:https://img.youtube.com/vi/rAteGra5-xM/maxresdefault.jpg[link=https://youtu.be/rAteGra5-xM, window="_blank"]
endif::[]
