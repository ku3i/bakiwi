...
Wir haben ein Video aufgezeichnet, um die Funktionsweise besser zu illustrieren. Wenn du magst, schau es dir an!

video::rAteGra5-xM[youtube]
link:https://youtu.be/rAteGra5-xM[Link zum Video]
